...
load data local inpath '/root/hive_data/user_info.txt' into table user_info;
...
1, xiaomi10, 1, 2020-01-01, 2000
2, 手机壳, 1, 2020-02-01, 10
3, apple12, 1, 2020-03-01, 5000
4, xiaomi13, 1, 2020-04-01, 6000
...
load data local inpath '/root/hive_data/sku_info.txt' into table sku_info;
